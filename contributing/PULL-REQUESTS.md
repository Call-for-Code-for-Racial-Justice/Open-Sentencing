...
* [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in Open Sentencing](#accept-that-there-are-different-opinions-about-what-belongs-in-open-sentencing)
...
More details to come on Call for Code for Racial Justice Open Sentencing dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Call-for-Code-for-Racial-Justice/Open-Sentencing/issues/) or engage on the
...
Fork the project [on GitHub](https://github.com/Call-for-Code-for-Racial-Justice/Open-Sentencing) and clone your fork
locally.

```text
$ git clone git@github.com:username/Open-Sentencing.git
$ cd Open-Sentencing
$ git remote add upstream https://github.com/Call-for-Code-for-Racial-Justice/Open-Sentencing.git
$ git fetch upstream
```
...
Open Sentencing does not yet have a style guide.
...
Fixes: https://github.com/Call-for-Code-for-Racial-Justice/Open-Sentencing/issues/343
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to Call for Code for Racial Justice Open Sentencing, please try to do your best at
...
at least two Open Sentencing Collaborators (one Collaborator approval is enough if the
...
All Open Sentencing contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Open Sentencing?
2. Does this change make Open Sentencing better, even if only incrementally?
...
Open Sentencing Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Open Sentencing better, but the individual might just
not want to have anything to do with Open Sentencing ever again. The goal is not just
having good code.
...
Any Open Sentencing core Collaborator (any GitHub user with commit rights in the
`Call-for-Code-for-Racial-Justice/Open-Sentencing` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in Open Sentencing

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if Open Sentencing itself needs it (due to historic
or functional reasons), then it belongs in Open Sentencing.
...
make Open Sentencing better. These may or may not make sense to add, but as with all
...
Open Sentencing has always optimized for speed of execution. If a particular change
can be shown to make some part of Open Sentencing faster, it's quite likely to be
...
That said, performance is not the only factor to consider. Open Sentencing also
...
to make sure that it works on the platforms that Open Sentencing
...
[Code of Conduct]: https://github.com/Call-for-Code-for-Racial-Justice/Open-Sentencing/CONTRIBUTING.md
